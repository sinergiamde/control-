...
serve(async (req) => {
  ...
  try {
    // Every message here is a real Claude call — require a logged-in user so this can't be
    // scripted for free by anyone who reads the public anon key out of the site's JS bundle.
